...
class EpsonPrinter:
    ...
    def __init__(self, id_vendor, id_product, interface=0, in_ep=0x82, out_ep=0x02):
        """
        ...
        if self.printer is None:
            raise Exception("Impresora not found. Make sure the cable is plugged in.")
